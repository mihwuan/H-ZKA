...
const (
	...
	// zkCross: Groth16 proof verification gas cost (Section 6 of zkCross paper)
	Groth16VerifyGas uint64 = 440000 // Gas needed for Groth16 zk-SNARK proof verification
